 ...
 */
public class PWMSettings extends ArduinoComponentSettings {

    private Integer value = 0;

    public PWMSettings(ArduinoManager arduinoManager, Integer pin, Node node) {
        super(arduinoManager);
        super.setType(ArduinoComponentType.PWM);
        if (pin != null) {
    ...
    private JPanel initInfoPanel(){
        ...
        inputContent.append("- Value: integer from <0-255>" + newline);
